...
public class BajaProveedorServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private static Logger log = Logger.getLogger(BajaProveedorServlet.class);

    public BajaProveedorServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (id != null && !id.isEmpty()) {
                ProveedorServicio.bajaProveedor(Integer.parseInt(id));
            ...
            log.error("Error al dar de baja el proveedor: " + e.getMessage());
            response.sendRedirect("error.jsp");
        } catch (Exception e) {
            log.error("Error al dar de baja el proveedor: " + e.getMessage());
            response.sendRedirect("error.jsp");
