...
@WebServlet("/PedidosDESC")
public class PedidosUsuarioDescendenteServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private static Logger log = Logger.getLogger(PedidosUsuarioDescendenteServlet.class);

    public PedidosUsuarioDescendenteServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<PedidoVO> pedidos = PedidoDAO.getPedidosUsuarioFecha(id, "DESC");
