        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="CrearCategoria" method="post">
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Nombre</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text"
                                                class="form-control p-0 border-0" id="nombre" name="nombre" required>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Descripción</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" class="form-control p-0 border-0" id="descripcion" name="descripcion">
                                        </div>
                                    </div>
